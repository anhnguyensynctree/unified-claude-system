...
|---|---|---|---|---|
| 001 | simple-routing | Basic | R1, R2, R3, R6, R7, D1 | Tier 1 classification, single-domain restraint |
...
## Criteria Coverage
All criteria from `validation-criteria.md` (Concerns 1–26) are covered by at least one scenario. Concerns with multi-scenario coverage: R2/R6 (10 scenarios), D1 (8), B1/B2 (4), AP1/AP2 (3), HD1/HD2 (3).
